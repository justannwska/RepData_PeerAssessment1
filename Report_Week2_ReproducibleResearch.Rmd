...
3) Eliminate NAs
4) Prepare a tbl object from data frame
...
```
It looks like mean values are similar but the median values is slighty increased 
for a dataset with imputed NAs.
